...
pub enum ItemFields {
    Owner = ObjectFields::End as isize,                         // Size: 2, Type: Long, Flags: Public
...
pub enum ContainerFields {
    NumSlots = ItemFields::End as isize,                     // Size: 1, Type: Int, Flags: Public
...
#[allow(non_camel_case_types)]
pub enum UnitFields {
    Charm = ObjectFields::End as isize,                                        // Size: 2, Type: Long, Flags: Public
...
pub enum PlayerFields {
    PlayerDuelArbiter = UnitFields::UnitEnd as isize,               // Size: 2, Type: Long, Flags: Public
...
pub enum GameObjectFields {
    ObjectFieldCreatedBy = ObjectFields::End as isize,      // Size: 2, Type: Long, Flags: Public
...
pub enum DynamicObjectFields {
    Caster = ObjectFields::End as isize,              // Size: 2, Type: Long, Flags: Public
