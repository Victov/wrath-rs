...
impl PacketHandler {
    ...
    async fn handle_packet(
        ...
        match packet.header.get_cmd()? {
            ...
            Opcodes::CMSG_READY_FOR_ACCOUNT_DATA_TIMES => {
                handle_csmg_ready_for_account_data_times(client_manager, packet).await
            }
            ...
            Opcodes::CMSG_UPDATE_ACCOUNT_DATA => {
                handle_csmg_update_account_data(client_manager, packet).await
            }
