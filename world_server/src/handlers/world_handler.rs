...
pub async fn send_temp_dummy_hardcoded_update(character: &Character) -> Result<()> {
    ...
    let (header, mut writer) = create_packet(Opcodes::SMSG_UPDATE_OBJECT, 8);
    let content = &[
        0x01, 0x00, 0x00, 0x00, 0x03, 0x07, 0x01, 0x02, 0x03, 0x04, 0x21,
        0x00, // Update Flags -> Living | Self
        ...
        0x00, 0x00, 0x00,
        0x00, // Swim Speed (swimming isn't enabled so we set this speed to 0)
        ...
        0x00, 0x0f, 0x49,
        0x40, // Turn Speed - how fast a character can turn around z axis (3.1415405f)
