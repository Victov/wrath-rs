...
use constants::{ObjectUpdateType, ObjectUpdateFlags, ObjectType};
use anyhow::Result;
use crate::guid::{WriteGuid, Guid};
...
fn build_movement_update<T: Updateable>(writer: &mut Cursor<Vec<u8>>, _subject: &T) -> Result<()>
{
    ...
    writer.write(&[0x21, 0x00,             // Update Flags -> Living | Self
...
fn build_values_update<T: Updateable>(writer: &mut Cursor<Vec<u8>>, subject: &T) -> Result<()>
{
    ...
    writer.write(&[0x2a, // Mask Size ((1326 + 31) / 32 = 42)
    ...
    writer.write(&[0x19, 0x00, 0x00, 0x00,  // OBJECT_FIELD_TYPE -> unit | player | object
